...
Adhoc Sub Processes are documented separately on [Adhoc Sub Processes](/{{page.collection}}/adhoc-subprocesses/).  They are an Enterprise Edition feature, and although they are modeled as a subprocess form, they behave differently from standard sequence-flow-driven subprocesses.
