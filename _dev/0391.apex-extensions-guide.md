---
permalink: /:collection/apex-extensions-guide/
title: "APEX BPMN Extensions Guide"
toc: true
typora-root-url: ../
---
...
- [Process API](/dev/api/) - Process API documentation
- [Process Variables](/dev/process-variable/) - Process variables guide
- [Variable Expressions](/dev/variable-expression/) - Variable expression reference
- [APEX Extensions Catalog](/dev/apex-extensions-catalog/) - Complete reference catalog
- [XSD Schema](https://github.com/flowsforapex/apex-flowsforapex/blob/development/doc/bpmn-extension-syntax/flow-for-apex-extensions.xsd){:target="_blank"} - XSD schema specification
