...
These concepts apply whether the AHSP is being controlled manually by a knowledge worker or, in Enterprise Edition, by an AI-driven controller.

## Runtime Mental Model

An AHSP is a bounded work area inside a process instance.
...
- a completion condition that decides when the AHSP can finish

The AHSP remains active until the completion condition becomes true.

## Currently Startable Activities

The most important AHSP concept is the set of **currently startable activities**.
...
In an AI-driven AHSP, the AI recommends or selects from that same currently startable set.
