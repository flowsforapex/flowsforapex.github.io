...
4. the completion condition that determines when the AHSP is finished
...
For PL/SQL task behavior in an AHSP, see [Configure a PL/SQL Script Task](/{{page.collection}}/script-task/).
