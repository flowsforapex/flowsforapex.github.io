...
### Naming
In Flows for APEX v22.2+, process variable names are case-independant.  So the variables `myVar`, `MYVAR`, and 'myvar` are all the same variable.
