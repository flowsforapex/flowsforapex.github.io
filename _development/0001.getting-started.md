...
### Installation
Download the latest version of the packaged app [here](https://github.com/flowsforapex/apex-flowsforapex/releases/download/v21.1/FlowsforAPEX_v21.1.zip) and import it into your APEX workspace.
...
- Integrate *Flows for APEX* in a custom application with the plug-ins
 ...
 To go further, we recommend you to follow our [BPMN tutorials]({{ site.url }}{{ site.baseurl }}/{{ page.collection }}/tutorials) or download our step by step [APEX integration tutorial]({{ site.url }}{{ site.baseurl }}/assets/files/Tutorial_Flows_for_APEX_v21.1.zip).