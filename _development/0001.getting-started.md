...
### Installation
Download the latest version of the packaged app [here](https://github.com/mt-ag/apex-flowsforapex/releases/download/v21.1/FlowsforAPEX_v21.1.zip) and import it into your APEX workspace.
