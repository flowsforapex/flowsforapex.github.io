...
From v22.1, timers can be specified in ISO 8601 format or in Oracle date and interval formats.  [Details of the syntax and substitutions allowed are shown here]({{ site.url }}{{ site.baseurl }}/{{ page.collection }}/timer-syntax.md).🆕
