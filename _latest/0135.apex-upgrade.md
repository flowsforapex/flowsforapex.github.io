...
Flows for APEX v26.1 is shipped as APEX 24.1 applications - so if your APEX version is > 24.1, you must upgrade the Universal Theme after installation or an APEX migration.
...
3. Select the **Engine App* configurations page.
4. **Monaco Editor Version**. Set the Monaco version number shipped with your new APEX version.  (If your APEX version number is not in the inline help, refer to the Oracle APEX documentation for your APEX version - Try searching for *JavaScript Library Upgrades* in the APEX Release Notes)
