...
*Flows for APEX* v26.1 minimal requirements are:
...
[Installing Flows for APEX Community Edition v26.1](/{{page.collection}}/installation_261)

[Migrating from earlier releases to Flows for APEX V26.1](/{{page.collection}}/migration)
