...
- [Logging Philosophy and Lifecycle](/{{page.collection}}/logging-philosophy-and-lifecycle/) - explains how Flows for APEX balances run-time visibility, archiving, and purging.
...
- [AI-Driven Adhoc Sub Processes](/{{page.collection}}/ai-driven-adhoc-subprocesses/) - explains the recommendation, hybrid, and autonomous control modes built on the Adhoc Sub Process base.
