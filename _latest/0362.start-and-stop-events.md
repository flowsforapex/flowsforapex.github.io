...
All process diagrams must start with a Start Event and end with one or more End Events.

![Start and End Events](/assets/images/startEndEvents.png "Start and End Events")

### Start Event ( <span class="bpmn-icon bpmn-icon-start-event-none"></span> )
